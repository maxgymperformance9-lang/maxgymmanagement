...
class MemberModel extends Model
{
   ...
   {
      // Since membership packages are removed, this method is now disabled
      return false;
   }
   ...
   {
      // Since membership packages are removed, renewal is disabled
      return false;
   }
   ...
   public function canAccessLocker($memberId)
   {
      ...
      // Since membership packages are removed, locker access is disabled
      return false;
   }
