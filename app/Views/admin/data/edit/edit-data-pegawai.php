         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-success">
                  <h4 class="card-title"><b>Form Edit Pegawai</b></h4>
               ...
               <div class="card-body mx-5 my-3">
                  ...
                  <form action="<?= base_url('admin/pegawai/edit'); ?>" method="post" enctype="multipart/form-data">
                     <?= csrf_field() ?>
                     ...
                     <div class="form-group mt-4">
                        ...
                        <input type="text" id="nama" class="form-control <?= $validation->getError('nama') ? 'is-invalid' : ''; ?>" name="nama" placeholder="Your Name" value="<?= old('nama') ?? $oldInput['nama'] ?? $data['nama_pegawai'] ?>" required>
                        <div class="invalid-feedback">
                           ...
                           <div class="col-md-6">
                              <?php if (!empty($data['foto'])): ?>
                                 <div class="mb-3">
                                    ...
                                    <img src="<?= base_url($data['foto']); ?>" alt="Foto Pegawai" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                                 </div>
                              <?php endif; ?>
                           </div>
                           <div class="col-md-6">
