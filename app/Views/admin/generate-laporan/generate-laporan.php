            ...
            <div class="card">
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6">
                        <div class="card h-100">
                           <form action="<?= base_url('admin/laporan/stock'); ?>" method="post" class="card-body d-flex flex-column">
                              <h4 class="text-dark"><b>Laporan Pergerakan Stok</b></h4>
                              <div class="row align-items-center">
                                 <div class="col-auto">
                                    <p class="d-inline"><b>Dari :</b></p>
                                 </div>
                                 <div class="col-5">
                                    <input type="date" name="startDateStock" id="startDateStock" class="form-control" value="<?= date('Y-m-01'); ?>">
                                 </div>
                              </div>
                              <div class="row align-items-center mt-2">
                                 <div class="col-auto">
                                 ...
                                 <div class="col-5">
                                    <input type="date" name="endDateStock" id="endDateStock" class="form-control" value="<?= date('Y-m-t'); ?>">
                                 </div>
                              </div>
                              <div class="mt-auto d-flex flex-column">
                                 <button type="submit" name="type" value="pdf" class="btn btn-danger pl-3">
