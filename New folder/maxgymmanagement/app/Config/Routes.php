...
$routes->group('admin', ['namespace' => 'App\Controllers\Admin'], static function (RouteCollection $routes) {
     ...
     * -------------------------
     */
    $routes->group('membership-packages', static function ($routes) {
        $routes->get('/', 'MembershipPackageController::index');
        $routes->get('create', 'MembershipPackageController::create');
        $routes->post('store', 'MembershipPackageController::store');
        $routes->get('edit/(:num)', 'MembershipPackageController::edit/$1');
        $routes->post('update/(:num)', 'MembershipPackageController::update/$1');
        $routes->delete('delete/(:num)', 'MembershipPackageController::delete/$1');
        $routes->post('ajax-list', 'MembershipPackageController::ajaxList');
        $routes->post('toggle-status/(:num)', 'MembershipPackageController::toggleStatus/$1');
    });
