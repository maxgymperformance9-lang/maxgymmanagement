                                ...
                                <div class="nav-tabs-navigation">
                                    <div class="row">
                                        <div class="col-md-4 col-lg-5">
                                            <h4 class="card-title"><b>Bulk Post Upload Penjaga</b></h4>
                                            <p class="card-category">Tahun <?= $generalSettings->office_year; ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <div id="csv_upload_spinner" class="csv-upload-spinner">
                                                <strong class="text-csv-importing">Importing Penjaga...</strong>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?= base_url('admin/petugas/downloadCSVFilePost'); ?>" method="post">
                                    <?= csrf_field(); ?>
                                    <button type="button" class="btn btn-success btn-block" data-toggle="modal" data-target="#modalKelas">List D.I/WIL</button>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalKelasTitle">List D.I/WIL</h5>
        ...
        if (index <= numberOfItems) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (objSub.result == 1) {
                        $("#csv_uploaded_files").prepend('<li class="list-group-item list-group-item-success">&nbsp;' + objSub.index + '.&nbsp;' + objSub.penjaga.nip + '.&nbsp; - ' + objSub.penjaga.nama_penjaga +'</li>');
                    } else {
