         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-primary">
                  <h4 class="card-title"><b>Form Tambah Penjaga</b></h4>

               </div>
               <div class="card-body mx-5 my-3">

                  <form action="<?= base_url('admin/penjaga/create'); ?>" method="post">
                     <?= csrf_field() ?>
                     ...
                     <div class="form-group mt-4">
                        ...
                        <input type="text" id="nip" class="form-control <?= $validation->getError('nip') ? 'is-invalid' : ''; ?>" name="nip" placeholder="1234" value="<?= old('nip') ?? $oldInput['nip']  ?? '' ?>">
                        ...
                        <div class="col-md-6">
                           ...
                           <select class="custom-select <?= $validation->getError('id_di') ? 'is-invalid' : ''; ?>" id="di" name="id_di">
                              ...
                              <?php foreach ($di as $value) : ?>
                                 <option value="<?= $value['id_di']; ?>" <?= old('id_di') ?? $oldInput['id_di'] ?? '' == $value['id_di'] ? 'selected' : ''; ?>>
