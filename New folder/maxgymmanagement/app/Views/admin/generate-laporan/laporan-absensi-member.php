...
<table>
   ...
   <tr>
      <td colspan="2"><b>Statistik Kehadiran Berdasarkan Tipe Member:</b></td>
   </tr>
   <tr>
      <td>Member Umum</td>
      <td>: <?= $attendanceByType['umum']['hadir']; ?> dari <?= $attendanceByType['umum']['total']; ?> member hadir</td>
   </tr>
   <tr>
      <td>Member Pelajar</td>
      <td>: <?= $attendanceByType['pelajar']['hadir']; ?> dari <?= $attendanceByType['pelajar']['total']; ?> member hadir</td>
   </tr>
   <tr>
      <td>Member Mahasiswa</td>
      <td>: <?= $attendanceByType['mahasiswa']['hadir']; ?> dari <?= $attendanceByType['mahasiswa']['total']; ?> member hadir</td>
   </tr>
   <tr>
      <td>Personal Trainer</td>
      <td>: <?= $attendanceByType['personal_trainer']['hadir']; ?> dari <?= $attendanceByType['personal_trainer']['total']; ?> member hadir</td>
   </tr>
   <tr>
      <td>Member + PT</td>
      <td>: <?= $attendanceByType['member_pt']['hadir']; ?> dari <?= $attendanceByType['member_pt']['total']; ?> member hadir</td>
   </tr>
</table>
