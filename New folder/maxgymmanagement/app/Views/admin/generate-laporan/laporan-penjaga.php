...
<table>
   <tr>
      ...
      <td width="100%">
         <h2 align="center">DAFTAR HADIR PENJAGA</h2>
...
<span style="position: absolute;right: 0;">D.i : <?= "{$di['di']} {$di['di']}"; ?></span>
<table align="center" border="1">
   ...
   <?php foreach ($listPenjaga as $penjaga) : ?>
      <?php
...
<table>
   <tr>
      <td>Jumlah Penjaga</td>
      <td>: <?= count($listPenjaga); ?></td>
   </tr>
   <tr>
      <td>Laki-laki</td>
      <td>: <?= $jumlahPenjaga['laki']; ?></td>
   </tr>
   <tr>
      <td>Perempuan</td>
      <td>: <?= $jumlahPenjaga['perempuan']; ?></td>
   </tr>
</table>
<?php
