                    ...
                    <div class="card-body mx-5 my-3">
                        ...
                        <form action="<?= base_url('admin/general-settings/update'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <input type="text" id="office_name" class="form-control <?= invalidFeedback('office_name') ? 'is-invalid' : ''; ?>" name="office_name" placeholder="SMK 1 Indonesia" value="<?= $generalSettings->office_name; ?>" required>
                                <div class="invalid-feedback">
                                    <?= invalidFeedback('office_name'); ?>
                                </div>
                            </div>

                            <div class="form-group mt-4">
                                <label for="office_year">Tahun Berdiri</label>
                                <input type="text" id="office_year" class="form-control <?= invalidFeedback('office_year') ? 'is-invalid' : ''; ?>" name="office_year" placeholder="2024/2025" value="<?= $generalSettings->office_year; ?>" required>
                                <div class="invalid-feedback">
                                    <?= invalidFeedback('office_year'); ?>
                                </div>
                            </div>
