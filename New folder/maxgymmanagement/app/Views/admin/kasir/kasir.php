                  ...
                  <div class="row">
                     ...
                     <div class="col-md-8">
                        ...
                        <div class="row" id="productList">
                           ...
                           <?php
                           $membershipPackageModel = new \App\Models\MembershipPackageModel();
                           $packages = $membershipPackageModel->getActivePackages();
                           foreach ($packages as $package): ?>
                              <div class="col-md-6 mb-3">
                                 <div class="card package-card" data-package-id="<?= $package['id_package'] ?>" data-nama="<?= esc($package['nama_package']) ?>" data-harga="<?= $package['harga'] ?>" data-type="package">
                                    <div class="card-body text-center">
                                       <h6 class="card-title"><?= esc($package['nama_package']) ?></h6>
                                       <p class="card-text">Rp <?= number_format($package['harga'], 0, ',', '.') ?></p>
                                       <p class="text-muted">Durasi: <?= $package['durasi_hari'] ?> hari</p>
                                       <?php if ($package['pt_sessions'] > 0): ?>
                                          <p class="text-muted">PT Sessions: <?= $package['pt_sessions'] ?></p>
                                       <?php endif; ?>
                                       <button class="btn btn-success btn-sm add-to-cart" data-id="<?= $package['id_package'] ?>" data-type="package">
                                          <i class="material-icons">card_membership</i> Tambah
                                       </button>
                                    </div>
                                 </div>
                              </div>
